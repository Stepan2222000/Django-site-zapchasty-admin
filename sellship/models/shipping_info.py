...
class EbayShippingInfo(models.Model):
    ...
    final_price = models.FloatField(db_column="финальная_цена", verbose_name="Финальная цена", default=0)
    ...
    order_link = models.URLField(max_length=256, db_column="ссылка_заказ", verbose_name="Ссылка на заказ", null=True, blank=True)
